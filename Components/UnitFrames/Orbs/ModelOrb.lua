...
DiabolicUI3ModelOrbMixin = {}
DiabolicUI3ModelOrbFillingMixin = {}
DiabolicUI3ModelOrbClipMixin = {}
DiabolicUI3ModelOrbOverlayMixin = {}

-------------------------------------------------------------
-- rModelOrbTemplate Layout
-------------------------------------------------------------

--  |> rModelOrbTemplate(DiabolicUI3ModelOrbMixin)
--    |> FillingStatusBar(DiabolicUI3ModelOrbFillingMixin)
--    |> ClipFrame(DiabolicUI3ModelOrbClipMixin)
--      |> ModelFrame(ModelSceneMixinTemplate)
--    |> OverlayFrame(DiabolicUI3ModelOrbOverlayMixin)
...
function DiabolicUI3ModelOrbMixin:OnLoad() end
function DiabolicUI3ModelOrbMixin:OnShow() end
function DiabolicUI3ModelOrbMixin:OnHide() end

-------------------------------------------------------------
-- rModelOrbTemplate:GetAllModelData()
-------------------------------------------------------------

function DiabolicUI3ModelOrbMixin:GetAllModelData()
...
function DiabolicUI3ModelOrbMixin:GetModelDataByID(id)
...
function DiabolicUI3ModelOrbMixin:SaveModelDataByID(id, data)
...
local function InitScene(scene, enableMouse)
  ...
  --camera
  scene.zorkCamera = CameraRegistry:CreateCameraByType("DiabolicUI3OrbCamera")
...
function DiabolicUI3ModelOrbMixin:LoadModelDataByID(id, enableMouse)
...
function DiabolicUI3ModelOrbFillingMixin:OnLoad()
  self:SetOrientation("VERTICAL")
  self:SetRotatesTexture(false)
  self:SetMinMaxValues(0, 1)
end

function DiabolicUI3ModelOrbFillingMixin:OnValueChanged(value) end
function DiabolicUI3ModelOrbFillingMixin:OnShow() end
function DiabolicUI3ModelOrbFillingMixin:OnHide() end

-------------------------------------------------------------
-- ClipFrame:OnLoad()
-------------------------------------------------------------

function DiabolicUI3ModelOrbClipMixin:OnLoad()
  self:SetClipsChildren(true)
end

function DiabolicUI3ModelOrbClipMixin:OnShow() end
function DiabolicUI3ModelOrbClipMixin:OnHide() end

-------------------------------------------------------------
-- OverlayFrame:OnLoad()
-------------------------------------------------------------

function DiabolicUI3ModelOrbOverlayMixin:OnLoad()
  ...
  mask:SetAllPoints()
  mask:SetTexture("Interface\\AddOns\\DiabolicUI3\\Assets\\modelorb\\orb_spark_mask", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
...
function DiabolicUI3ModelOrbOverlayMixin:OnShow() end
function DiabolicUI3ModelOrbOverlayMixin:OnHide() end
